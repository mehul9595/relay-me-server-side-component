 ...
 * @api public
 */
function BasicUrlStrategy(options, verify) {
 ...
 */
util.inherits(BasicUrlStrategy, passport.Strategy);

/**
 * Authenticate request based on the contents of a HTTP Basic authorization header.
 * 
 * @param {Object}
 *            req
 * @api protected
 */
BasicUrlStrategy.prototype.authenticate = function(req) {
 ...
 * @api private
 */
BasicUrlStrategy.prototype._challenge = function() {
 ...
 */
module.exports = BasicUrlStrategy;
